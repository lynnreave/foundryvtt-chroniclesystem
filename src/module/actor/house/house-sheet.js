 ...
 * @category Actor
 */
export class HouseSheet extends ActorSheetChronicle {
    itemTypesPermitted = [
        "event",
        "holding"
    ]
    ...
    async _openResourceEditor(ev) {
        ...
        const html = await renderTemplate(template, {
            startingValue: data.actor.getData()[resourceId].startingValue,
            description: data.actor.getData()[resourceId].description,
