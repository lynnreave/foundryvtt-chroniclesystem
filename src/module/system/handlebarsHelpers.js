...
export const registerCustomHelpers = function () {
  ...
  Handlebars.registerHelper("for", function (from, to, incr, block) {
    let accum = "";
    for (let i = from; i <= to; i += incr) accum += block.fn({ index: i });
    return accum;
  });
  ...
  Handlebars.registerHelper(
    "showIfTrue",
    function (arg1, result1, result2 = "", options) {
      return arg1 === true ? result1 : result2;
    }
  );
  ...
  Handlebars.registerHelper(
    "showIfFalse",
    function (arg1, result1, result2 = "", options) {
      return arg1 === false ? result1 : result2;
    }
  );
